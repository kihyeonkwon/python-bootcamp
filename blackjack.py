...
print("I'm sitting at a blackjack table")
time.sleep(3)
player_chips = Chips(500)
print("I have fucked up my life.. I changed my entire deposit into chips.")
highest_chip = player_chips.total
time.sleep(3)
print("500 chips to spend a goodtime for the lasttime :)")
time.sleep(2)
print("If I get more than 10,000 chips I can pay off my debts and start a new life!!!")
time.sleep(2)
print("Fate awaits me :)")
time.sleep(3)
...
while True:
    ...
    print("Dealer receives two cards!")
    time.sleep(2)
    dealer_hand.add_card(deck.deal())
    ...
    while playing:
        ...
        if player_hand.value <= 21:
            ...
            while dealer_hand.value < 17:
                print("dealer is contemplating...")
                time.sleep(6)
                print("dealer will take another hit!")
                time.sleep(3)
            ...
            print("dealer is contemplating...")
            time.sleep(5)
            print("dealer stops hits! Time to reveal cards!")
            time.sleep(1)
